...
@section('content')
    <div class="element-actions">
        <a class="mr-2 mb-2 btn btn-success" href="{{ route('categories.index') }}">
    ...
    <div class="element-box timeline">
		...
		<fieldset>
			<div class="buttons-w">
                <a class="btn btn-success" href="{{route('categories.index')}}">Все</a>
                <a class="btn btn-primary" href="{{ route('categories.edit', $row) }}">Изменить</a>
                {!! Form::open(['method' => 'DELETE','route' => ['categories.destroy', $row],'style'=>'display:inline', 'onsubmit' => 'return confirmDelete()']) !!}
