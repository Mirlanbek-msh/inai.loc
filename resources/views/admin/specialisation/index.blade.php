...
@section('title', trans('t.all_specialisations'))

@section('content')

    <div class="element-actions">
        <a class="btn btn-primary btn-sm" href="{{ route('admin.specialisation.create') }}"><i class="os-icon os-icon-ui-22"></i><span>{{trans('t.create_specialisation')}}</span></a>
    </div>
    <h6 class="element-header">
        {{trans('t.all_specialisations')}}
    </h6>
                ...
                @foreach ($data as $key => $row)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            {!! Form::open(['method' => 'DELETE','route' => ['admin.specialisation.destroy', $row->id],'style'=>'display:inline', 'onsubmit' => 'return confirmDelete()']) !!}
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#datatables tbody').on( 'click', 'tr', function (el) {
                ...
                window.location.href = "specialisation/"+ data[0];
            });
        });
    </script>
